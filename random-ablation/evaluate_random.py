...
def main(args):
    ...
    # Save to file
    if args.model == "gtr-base":
        with open(f"gtr_pretrained_{args.num_steps}_random_results.json", "w") as f:
            json.dump(metrics, f, indent=4)
    else:
        with open(f"gtr_ours_{args.num_steps}_random_results.json", "w") as f:
            json.dump(metrics, f, indent=4)
...
if __name__ == "__main__":
    ...
    """
    python evaluate_random.py --model gtr-base --num_steps 0 --batch_size 384
    python evaluate_random.py --model gtr-base --num_steps 20 --batch_size 384
    """
