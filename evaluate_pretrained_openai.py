...
def main(args):
    ...
    # Save to file 
    with open(f"openai_msmarco_{args.num_steps}_results.json", "w") as f:
...
if __name__ == "__main__":
    ...
    """
    python3 -m vec2text.evaluate_pretrained_openai --num_steps 0 --batch_size 384;
    python3 -m vec2text.evaluate_pretrained_openai --num_steps 20 --batch_size 64
