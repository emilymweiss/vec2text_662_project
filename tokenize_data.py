...
Editors: Leonardo Blas

Code source: 
https://github.com/jxmorris12/vec2text/blob/master/vec2text/tokenize_data.py

Edited embed_dataset_batch function with code to add noise to embeddings.
